...
(function () {
  var originalSetOverlayColor = fabric.StaticCanvas.prototype.setOverlayColor;
  var originalSetOverlayImage = fabric.StaticCanvas.prototype.setOverlayImage;
  fabric.util.object.extend(fabric.StaticCanvas.prototype, {
     ...
     * @chainable true
     */
    __setBgOverlayColor: function (
      property: "backgroundColor" | "overlayColor",
      color: any,
      ...
      if (property === "overlayColor") {
        typeof originalSetOverlayColor === "function" &&
          originalSetOverlayColor.call(this, color, cb);
      } else {
        this[property] = color;
        cb();
      }
     ...
     */
    __setBgOverlay: function (
      property: string | fabric.Image,
      value: any,
      loaded: any,
      callback: any
    ) {
      ...
      if (
        ...
        originalSetOverlayImage.call(property, value, loaded, callback);
      }
    },
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
     ...
     */
    toObject: function (additionalProperties: ConcatArray<string>) {
  ...
  fabric.BaseBrush = fabric.util.createClass(
    ...
    /** @lends fabric.EraserBrush.prototype */ {
       ...
       */
      prepareCanvasBackgroundForLayer: function (layer: string) {
        if (layer === "overlay") {
          return;
        }
       ...
       */
      prepareCanvasOverlayForLayer: function (layer: string) {
        var canvas = this.canvas;
      ...
      prepareCollectionTraversal: function (collection: {
        forEachObject: (arg0: (obj: any) => void) => void;
      }) {
        var _this = this;
      ...
      restoreCollectionTraversal: function (collection: {
        ...
        var _this = this;
        collection.forEachObject(function (obj: { forEachObject: any }) {
          if (obj.forEachObject) {
       ...
       * @param {'bottom' | 'top' | 'overlay'} layer
       */
      prepareCanvasObjectsForLayer: function (layer: string) {
       ...
       * @param {'bottom' | 'top' | 'overlay'} layer
       */
      restoreCanvasObjectsFromLayer: function (layer: string) {
        if (layer !== "bottom") return;
       ...
       * @returns boolean render overlay above brush
       */
      prepareCanvasForLayer: function (layer: any) {
       ...
       * @param {'bottom' | 'top' | 'overlay'} layer
       */
      restoreCanvasFromLayer: function (layer: any) {
       ...
       */
      _saveAndTransform: function (ctx: { globalCompositeOperation: string }) {
      ...
      onMouseDown: function (
        pointer: Point,
        options: { e: MouseEvent | TouchEvent }
      ) {
       ...
       */
      _addPathToObjectEraser: function (
        obj: {
          forEachObject: (arg0: (_obj: any) => void) => void;
          getEraser: () => any;
          width: number;
          height: number;
          clipPath: any;
          calcTransformMatrix: () => any[];
          set: (arg0: { clipPath: any; dirty: boolean }) => void;
        },
        path: { clone: (arg0: (path: fabric.Path) => void) => void }
      ) {
        var clipObject: fabric.Group;
        var _this = this;
        //  object is collection, i.e group
        if (obj.forEachObject) {
          obj.forEachObject(function (_obj: { erasable: boolean }) {
            if (_obj.erasable) {
        ...
        path.clone(function (path: fabric.Path) {
       ...
       */
      applyEraserToCanvas: function (path: fabric.Path) {
        var canvas = this.canvas;
        this.forCanvasDrawables((imgProp: any, _: any, colorProp: any) => {
      ...
      _finalizeAndAddPath: function () {
        ...
        canvas.forEachObject(function (obj: {
          erasable: boolean;
          intersectsWithObject: (arg0: any) => any;
        }) {
