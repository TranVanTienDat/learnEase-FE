...
export default class Slot {
  ...
  public async spin(): Promise<boolean> {
    ...
    randomNames.forEach((name) => {
      ...
      newReelItem.style.transform = "translateZ(0)";
      newReelItem.style.fontSize = "60px";
      newReelItem.style.height = "7.5rem";
      newReelItem.style.lineHeight = "7.5rem";
      newReelItem.style.textOverflow = "ellipsis";
      newReelItem.style.color = "#000000";
      newReelItem.style.fontWeight = "700";
      newReelItem.style.overflow = "hidden";
      newReelItem.style.textAlign = "center";
      newReelItem.style.whiteSpace = "nowrap";
